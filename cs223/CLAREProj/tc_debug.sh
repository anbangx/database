...
# Start the Java RMI registry(1099 - TC)
rmiregistry 1099 &

# Start the server(TC)
java -Xdebug -Xnoagent -Xrunjdwp:transport=dt_socket,server=y,address=7002,suspend=y -cp ".:./lib/*:./ics/uci/edu/table:./ics/uci/edu/rmi:./lib/httpcore-4.0.1.jar:" -Djava.rmi.server.codebase=file:./ ics.uci.edu.rmi.TCServer &
